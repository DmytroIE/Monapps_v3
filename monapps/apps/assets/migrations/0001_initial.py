    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Generic', 'Generic'), ('Site', 'Site'), ('Workshop', 'Workshop'), ('BOILER', 'Boiler'), ('DEAERATOR', 'Deaerator'), ('Steam trap', 'Steam Trap'), ('Heat exchanger', 'Heat Ex'), ('Heating package', 'Heat Package'), ('Control valve', 'Control Valve'), ('PRS', 'Prs'), ('Safety valve', 'Safety Valve'), ('Mechanical pump', 'Mech Pump'), ('Mechanical pump CRU', 'Mech Pump Cru'), ('Electrical pump', 'El Pump'), ('Electrical pump CRU', 'El Pump Cru')], default='Generic')),
                ...
                ('fields_to_update', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=50), size=None)),
