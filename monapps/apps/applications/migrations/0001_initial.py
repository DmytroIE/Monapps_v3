    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_purp', models.CharField(choices=[('None', 'None'), ('Leaking', 'Leaking'), ('Blocked', 'Blocked'), ('Flooded', 'Flooded'), ('Broken', 'Broken'), ('Malfunctioning', 'Malfunctioning')], default='None')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('t_resample', models.BigIntegerField(default=60000)),
                ...
                ('t_status_eval', models.BigIntegerField(default=60000)),
                ('t_curr_state_eval', models.BigIntegerField(default=60000)),
                ...
                ('t_status_stale', models.BigIntegerField(default=1296000000)),
                ('t_curr_state_stale', models.BigIntegerField(default=600000)),
                ...
                ('t_health_error', models.BigIntegerField(default=600000)),
                ('catch_up_interval', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='catching_up_apps', related_query_name='catching_up_app', to='django_celery_beat.intervalschedule')),
                ('invoc_interval', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='norm_speed_apps', related_query_name='norm_speed_app', to='django_celery_beat.intervalschedule')),
                ('parent', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='apps', related_query_name='app', to='assets.asset')),
