...
DEFAULT_T_RESAMPLE = AllowedIntervalsMs.MIN
DEFAULT_T_STATUS_STALE = AllowedIntervalsMs.DAY * 15
DEFAULT_T_CURR_STATE_STALE = AllowedIntervalsMs.TEN_MIN
DEFAULT_T_APP_HEALTH_ERROR = AllowedIntervalsMs.TEN_MIN
