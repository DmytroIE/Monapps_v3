...
def stall_detection_by_two_temps_0_0_1(
    ...
    print("We are in 'stall_detection_by_two_temps_0_0_1'")
    ...
    end_rts, is_catching_up = get_end_rts(native_df_map.values(), app.t_resample, start_rts, num_df_to_process)
    ...
    if end_rts > start_rts:  # all datafeed have readings with ts > cursor_ts
        ...
        grid = create_grid(start_rts + app.t_resample, end_rts, app.t_resample)
            ...
            if temp_inlet is not None and temp_outlet is not None:
                if temp_outlet - temp_inlet > 0.5:
                    ...
                    if temp_inlet - temp_outlet > delta_t_in:
                        ...
                        add_to_alarm_payload(alarm_payload, "Stall detected", {}, rts, "w")
